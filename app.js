...
return [sum2[0] ,"2,3,4 was passed in as an array of numbers, and 9 is their sum."]
...
var multiply2= multiply ( multiply1 [0] ,multArr[2]);
return [ multiply2[0],"The numbers 2,3,4 have a product of 24."]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var complexMult1 = multiply(testDynamicArray[0],testDynamicArray[1]);
    var complexMult2 = multiply(complexMult1[0] , testDynamicArray[2]);
    var complexMult3 = multiply(complexMult2[0] ,testDynamicArray[3]);
    var complexMult4 = multiply(complexMult3[0],testDynamicArray[4]);
    return [complexMult4[0], "The numbers 1,2,3,4,5 have a product of 120."]
